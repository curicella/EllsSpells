...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-my-beige-3 text-sm font-medium leading-5 text-white focus:outline-none focus:border-my-beige-2 transition duration-150 ease-in-out'
